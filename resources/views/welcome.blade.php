<x-app-layout>
    <div id="default-carousel" class="relative w-full h-[30rem]" data-carousel="slide">
        ...
        <div class="carousel-button container flex flex-col items-center px-6 py-4 mx-auto text-center">
            <div class="inline-flex w-full mt-6 sm:w-auto">
                <a href="{{ route('studio') }}"
                    class="inline-flex items-center justify-center w-full px-8 py-3 text-dark text-bold duration-300 bg-gray-300 rounded-lg hover:bg-gray-300 focus:ring focus:ring-gray-300 focus:ring-opacity-80">
                    Book Now
                </a>
            </div>
        </div>
    ...
    <style>
        .carousel-button {
            position: absolute;
            z-index: 50;
            /* Pastikan nilai z-index lebih tinggi dari carousel */
            top: 75%;
            left: 50%;
            transform: translate(-50%, -50%);
        }

        /* .carousel-button a.bg-transparent {
            background-color: rgba(52, 152, 219, 0.3);
            /* Warna solid dengan tingkat transparansi */
